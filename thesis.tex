...
%   screen      - sets a background color, flame vinyl shade, and sans serif fonts
%
% For more info see `README.md`
\documentclass[screen,withindex,glossary]{cam-thesis}
...
\collegeshield{CollegeShields/PimpMyCode}
...
\chapter{The Answer to the Ultimate Question of Life, The Universe, and Everything}
